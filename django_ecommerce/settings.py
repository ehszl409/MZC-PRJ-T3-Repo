...
def get_parameter(parameter_name):
    try:
        response = ssm.get_parameter(
            Name=f"{parameter_path}{parameter_name}", WithDecryption=True
        )
...
db_prd_endpoint = get_parameter("prd-endpoint")
...
CKEDITOR_JQUERY_URL = (
    "https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js"  # noqa
)
